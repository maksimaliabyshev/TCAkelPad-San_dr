...
Если после переключения в режим редактирования через F4 и обратно на чтение, Lister перестал реагировать на кнопки, нужно нажать Ctrl+Tab, что бы фокус переключился на Lister.<br/>

Начертания внутренних шрифтов Nerd Font Proto можно поменять через "Диалог выбора" шрифта, так как редактор самостоятельно может менять только 4 начертания.
