...
- Клавиша F4 - включает/отключает режим редактирования AkelPad<br/>
⚠️ Режим быстрого просмотра TC через Ctrl+Q не работает, мигает и не реагирует [плагин пока в разработке]
<br/>
AkelPad:
